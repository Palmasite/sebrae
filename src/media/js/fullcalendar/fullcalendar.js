...
var defaults = {
	...
	isRTL: false,
	firstDay: 0,
	monthNames: ['Janeiro','Fevereiro','Março','Abril','Maio','Junho','Julho','Agost','Stembro','Outubro','Novembro','Dezembro'],
	monthNamesShort: ['Jan','Fev','Mar','Abr','Mai','Jun','Jul','Ago','Set','Out','Nov','Dez'],
	dayNames: ['Domengo','Segunda','Terça','Quarta','Quinta','Sexta','Sabado'],
